...
<body>
	...
	<form action="getUser" class="container my-5">
		<div class="mb-3">
			<label class="form-label">Enter Your ID</label> <input type="number"
				class="form-control" name="id" autocomplete="off">
		</div>
	...
	<h2>Display Delete User Details</h2>
	<form action="deleteUser" class="container my-5">
		<div class="mb-3">
			<label class="form-label">Enter Your ID</label> <input type="number"
				class="form-control" name="id" autocomplete="off">
		</div>
	...
	<form action="updateUser" class="container my-5">
		<div class="mb-3">
			<label class="form-label">Enter Your ID</label> <input type="number"
				class="form-control" name="id" autocomplete="off">
		</div>
